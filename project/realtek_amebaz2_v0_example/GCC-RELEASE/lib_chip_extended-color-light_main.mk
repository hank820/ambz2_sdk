...
OUTPUT_DIR = $(CHIPDIR)/examples/extended-color-light/ameba/build/chip
...
INCLUDES += -I$(CHIPDIR)/zzz_generated/extended-color-light
INCLUDES += -I$(CHIPDIR)/zzz_generated/extended-color-light/zap-generated
INCLUDES += -I$(CHIPDIR)/examples/extended-color-light/extended-color-light-common
INCLUDES += -I$(CHIPDIR)/examples/extended-color-light/ameba/main/include
INCLUDES += -I$(CHIPDIR)/examples/extended-color-light/ameba/build/chip/gen/include
...
SRC_CPP += $(CHIPDIR)/zzz_generated/extended-color-light/zap-generated/callback-stub.cpp
SRC_CPP += $(CHIPDIR)/zzz_generated/extended-color-light/zap-generated/IMClusterCommandHandler.cpp

SRC_CPP += $(CHIPDIR)/examples/extended-color-light/ameba/main/chipinterface.cpp
SRC_CPP += $(CHIPDIR)/examples/extended-color-light/ameba/main/DeviceCallbacks.cpp
