...
SRC_CPP += $(CHIPDIR)/zzz_generated/thermostat/zap-generated/callback-stub.cpp
SRC_CPP += $(CHIPDIR)/zzz_generated/thermostat/zap-generated/IMClusterCommandHandler.cpp

SRC_CPP += $(CHIPDIR)/examples/thermostat/ameba/main/chipinterface.cpp
SRC_CPP += $(CHIPDIR)/examples/thermostat/ameba/main/DeviceCallbacks.cpp
SRC_CPP += $(CHIPDIR)/examples/thermostat/ameba/main/CHIPDeviceManager.cpp
SRC_CPP += $(CHIPDIR)/examples/thermostat/ameba/main/Globals.cpp
SRC_CPP += $(CHIPDIR)/examples/thermostat/ameba/main/ThermostatManager.cpp
SRC_CPP += $(CHIPDIR)/examples/thermostat/ameba/main/DsoHack.cpp
