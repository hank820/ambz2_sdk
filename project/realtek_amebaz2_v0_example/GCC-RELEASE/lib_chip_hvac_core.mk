...
GENERATE_NINJA:
	...
	cd $(CHIPDIR)/config/ameba/components/chip && gn gen --check --fail-on-unused-args $(CHIPDIR)/examples/hvac-app/ameba/build/chip
	cd $(CHIPDIR)/config/ameba/components/chip ; ninja -C $(CHIPDIR)/examples/hvac-app/ameba/build/chip :ameba
