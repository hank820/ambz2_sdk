...
GENERATE_NINJA:
	...
	cd $(CHIPDIR)/config/ameba/components/chip && gn gen --check --fail-on-unused-args $(CHIPDIR)/examples/extended-color-light/ameba/build/chip
	cd $(CHIPDIR)/config/ameba/components/chip ; ninja -C $(CHIPDIR)/examples/extended-color-light/ameba/build/chip :ameba
