...
OUTPUT_DIR = $(CHIPDIR)/examples/hvac-app/ameba/build/chip
...
INCLUDES += -I$(CHIPDIR)/zzz_generated/app-common/zap-generated
INCLUDES += -I$(CHIPDIR)/zzz_generated/hvac-app
INCLUDES += -I$(CHIPDIR)/zzz_generated/hvac-app/zap-generated
INCLUDES += -I$(CHIPDIR)/examples/hvac-app/hvac-common
INCLUDES += -I$(CHIPDIR)/examples/hvac-app/hvac-common/include
INCLUDES += -I$(CHIPDIR)/examples/hvac-app/ameba/main
INCLUDES += -I$(CHIPDIR)/examples/hvac-app/ameba/main/include
INCLUDES += -I$(CHIPDIR)/examples/hvac-app/ameba/build/chip/gen/include
...
INCLUDES += -I$(CHIPDIR)/src/app/clusters/scenes
...
SRC_CPP += $(CHIPDIR)/zzz_generated/hvac-app/zap-generated/callback-stub.cpp
SRC_CPP += $(CHIPDIR)/zzz_generated/hvac-app/zap-generated/IMClusterCommandHandler.cpp

SRC_CPP += $(CHIPDIR)/examples/hvac-app/ameba/main/chipinterface.cpp
SRC_CPP += $(CHIPDIR)/examples/hvac-app/ameba/main/DeviceCallbacks.cpp
SRC_CPP += $(CHIPDIR)/examples/hvac-app/ameba/main/CHIPDeviceManager.cpp
SRC_CPP += $(CHIPDIR)/examples/hvac-app/ameba/main/Globals.cpp
SRC_CPP += $(CHIPDIR)/examples/hvac-app/ameba/main/ThermostatManager.cpp
SRC_CPP += $(CHIPDIR)/examples/hvac-app/ameba/main/FanManager.cpp
SRC_CPP += $(CHIPDIR)/examples/hvac-app/ameba/main/DsoHack.cpp
